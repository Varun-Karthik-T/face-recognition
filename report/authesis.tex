...
\begin{center}
  \LARGE
  \textbf{\uppercase{automated face recognition and suspicious activity detection enhancing home security }} \\
 ...
 \vspace{0.2\baselineskip}
  ...
  \Large \textbf{SALAI KOWSHIKAN S - 2022115081}\\
  % \normalsize{\textbf{(2022115081)}}\\
  \Large \textbf{EZHIL DHIRAVIYA J - 2022115077}\\
  % \normalsize{\textbf{(2022115077)}}\\
  \Large \textbf{VARUN KARTHIK T - 2022115060}\\
  % \normalsize{\textbf{(2022115060)}}\\
...
\begin{spacing}{1.5}
  \begin{sloppypar}
  \fontsize{13}{14.5}\selectfont Certified that this project report titled \textbf{“AUTOMATED FACE RECOGNITION AND SUSPICIOUS ACTIVITY DETECTION ENHANCING HOME SECURITY”} is the bonafide
work of \textbf{SALAI KOWSHIKAN S (2022115081), EZHIL DHIRAVIYA J (2022115077), and VARUN KARTHIK T (2022115060), } who carried out project work under
...
\begin{flushleft}
 ...
 \small{\textbf{DATE: }}}
 \hfill
 \parbox[t]{5 cm}{\small{\textbf{Dr. K. VANI}} \\
...
\include{Abstract/abstracttamil}
\include{acknowl}
